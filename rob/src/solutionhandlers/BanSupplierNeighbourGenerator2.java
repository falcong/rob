...
public class BanSupplierNeighbourGenerator2 extends NeighbourGenerator{
	protected Problem problem;
	
	public BanSupplierNeighbourGenerator2(Problem problem) {
	...
	public Solution generate(Solution solution, int distance){
		...
		for (int i=0;i<distance;i++) {
			boolean ok=false;
			do{
				int supplierId = (int)(Math.random()*suppliersPoolSize+1);
